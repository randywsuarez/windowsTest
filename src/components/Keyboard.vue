			...
			<div id="kb_box_l">
				<div v-for="row in keyRows" :key="row.id" class="kb_row">
					<div
						...
						:id="key.id"
						:style="{ backgroundColor: key.pressed ? '#00FF00' : 'rgba(255, 255, 255, 0.1)' }"
				...
				keyRows: [
					{
						...
						keys: [
							...
							{ id: 'kb_btn_F1', label: 'F1', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_F2', label: 'F2', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_F3', label: 'F3', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_F4', label: 'F4', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_F5', label: 'F5', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_F6', label: 'F6', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_F7', label: 'F7', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_F8', label: 'F8', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_F9', label: 'F9', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_F10', label: 'F10', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_F11', label: 'F11', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_F12', label: 'F12', size: 'kb_btn_small', pressed: false },
						],
					},
					{
						id: 2,
					...
					},
					{
						...
						keys: [
							...
							{ id: 'kb_btn_Backslash', label: '|<br>\\', size: 'kb_btn_medium', pressed: false },
						],
					},
					{
						id: 4,
						keys: [
							{ id: 'kb_btn_CapsLock', label: 'Caps<br>Lock', size: 'kb_btn_large', pressed: false },
					...
					},
					{
						...
						keys: [
							...
							{ id: 'kb_btn_FnLeft', label: 'Fn', size: 'kb_btn_large', pressed: false },
							{ id: 'kb_btn_Space', label: 'Space', size: 'kb_btn_space', pressed: false },
							{ id: 'kb_btn_FnRight', label: 'Fn', size: 'kb_btn_large', pressed: false },
					...
					},
					{
						id: 7,
						keys: [
							{ id: 'kb_btn_ArrowUp', label: '↑', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_ArrowLeft', label: '←', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_ArrowDown', label: '↓', size: 'kb_btn_small', pressed: false },
							{ id: 'kb_btn_ArrowRight', label: '→', size: 'kb_btn_small', pressed: false },
						],
					},
				],
				showStartModal: true,
